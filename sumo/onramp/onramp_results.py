...
best_param_map = {
    ...
    "sl3b": {'maxSpeed': 30.261502374214643, 'minGap': 2.018851926386442, 'accel': 1.3635832799527186, 'decel': 2.7045470127994378, 'tau': 1.7681100443342828, 'lcSublane': 9.09684871539489, 'maxSpeedLat': 6.468200872814605, 'lcAccelLat': 1.1137958354032362, 'minGapLat': 0.8814040582063805, 'lcStrategic': 6.6203940225588225, 'lcCooperative': 0.4514090070927672, 'lcPushy': 0.4801754062586234, 'lcImpatience': 0.6818077888996774, 'lcSpeedGain': 0.12778460944698583}
}
...
def run_with_param(parameter, exp_label="", rerun=True, plot_ts=False, plot_det=False, plot_macro=False):
    ...
    if plot_ts:
        ...
        plt.savefig(f"figures/{exp_label}_fcd.png", dpi=100, bbox_inches='tight') 
        plt.close()
    if plot_det:
        ...
        fig.savefig(f"figures/{exp_label}_det.png", dpi=100, bbox_inches='tight') 
    return
...
if __name__ == "__main__":
    ...
    # save_path = "figures/sl3b.png"
    # fig=None
    # axes=None
    # for i,exp_label in enumerate(["gt_sublane", "sl3b"]):
